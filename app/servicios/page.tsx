...
export default function ServicesPage() {
  return <><section className="page-hero page-hero-services"><div className="wrap"><div className="breadcrumb"><a href="/">Inicio</a><span>/</span>Servicios</div><div className="eyebrow light"><span /> Catálogo integral</div><h1>Encuentra el servicio ambiental que tu proyecto necesita.</h1><p>Explora el catálogo por palabra, área o sector. Si aún no tienes claro el alcance, solicita una orientación inicial.</p></div></section><section className="section wrap"><ServicesExplorer /></section></>;
}
