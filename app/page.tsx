...
export default function Home() {
  return <>
    ...
    <section className="about-home about-showcase section">
      <div className="side-gallery side-gallery-left" aria-label="Trabajo de campo y biodiversidad">
        <figure className="field side-photo side-photo-one"><img src="/images/campo-forestal.webp" alt="Especialistas realizan una evaluación forestal en campo" loading="lazy" /></figure>
        <figure className="field side-photo side-photo-two"><img src="/images/campo-biodiversidad.webp" alt="Especialista realiza un registro fotográfico de biodiversidad en campo" loading="lazy" /></figure>
        <figure className="field side-photo side-photo-three"><img src="/images/campo-fauna-nocturna.webp" alt="Especialista sostiene un anfibio durante un registro nocturno de fauna" loading="lazy" /></figure>
      </div>
      ...
      <div className="side-gallery side-gallery-right" aria-label="Monitoreo ambiental en distintos territorios">
        <figure className="field side-photo side-photo-one"><img src="/images/campo-agua-nueva.webp" alt="Especialistas realizan un muestreo de agua en una laguna altoandina" loading="lazy" /></figure>
        <figure className="field side-photo side-photo-two"><img src="/images/campo-monitoreo-aire.webp" alt="Especialistas realizan un monitoreo de calidad del aire" loading="lazy" /></figure>
        <figure className="field side-photo side-photo-three"><img src="/images/campo-dunas.webp" alt="Especialistas realizan un registro fotográfico en un ecosistema de dunas" loading="lazy" /></figure>
      </div>
    </section>
