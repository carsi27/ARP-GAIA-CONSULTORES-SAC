...
export default function Home() {
  return <>
    ...
    <section className="about-home section wrap">
      <div className="field-collage" aria-label="Trabajo de campo de ARP GAIA"><figure className="field field-one"><img src="/images/campo-bosque.png" alt="Evaluación técnica en una zona boscosa" loading="lazy" /></figure><figure className="field field-two"><img src="/images/campo-agua.png" alt="Muestreo de agua realizado en campo" loading="lazy" /></figure><figure className="field field-three"><img src="/images/campo-agricultura.png" alt="Recorrido técnico en una zona agrícola" loading="lazy" /></figure><div className="field-badge"><b>Territorio</b><span>Trabajo técnico en campo</span></div></div>
